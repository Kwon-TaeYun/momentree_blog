...
export default function WithdrawPage() {
  ...
  const handleWithdraw = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 회원 탈퇴 API 호출
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_BASE_URL || 'http://localhost:8090'}/api/v1/members/withdraw`, {
        method: 'POST',
      ...
      <div className="flex">
        ...
        <main className="flex-1 p-8">
          ...
          <div className="bg-white rounded-lg border border-gray-100 p-6 mb-6">
            <div className="mb-6">
              <h2 className="text-lg font-semibold mb-2">탈퇴 전 꼭 확인해주세요</h2>
              <ul className="list-disc pl-5 space-y-2 text-gray-700">
                <li>탈퇴 후에는 계정을 복구할 수 없습니다.</li>
                <li>작성하신 게시글 및 댓글은 자동으로 삭제되지 않습니다.</li>
                <li>작성 게시글 및 댓글 삭제를 원하시면 탈퇴 전에 직접 삭제해주세요.</li>
            ...
            <form onSubmit={handleWithdraw}>
              <div className="mb-4">
                ...
                >
                  ...
                  <option value="더 나은 서비스">더 나은 서비스를 찾았어요</option>
              ...
              <div className="flex justify-end">
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded ${
                    isConfirmed ? 'bg-red-600 text-white hover:bg-red-700' : 'bg-gray-300 text-gray-500 cursor-not-allowed'
                  }`}
                >
